...
public class ListTowServiceActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		AdRequest adRequest = new AdRequest.Builder()
				...
				.addTestDevice("TEST_DEVICE_ID").addKeyword("automobile")
				.build();
		...
		actionBar.setIcon(R.drawable.tow);
		...
		ListPOIPlacesActivity.getPOIList(ListTowServiceActivity.this, this,
				mLocation, null, keyword, "textsearch");
