...
public class POITextSearchTask extends
		AsyncTask<Location, String, PlacesResult> {
	...
	protected PlacesResult doInBackground(Location... params) {
		...
		try {
			...
			placesResult = (PlacesResult) googlePlaces.getTextPlaces(mTypes,
					mSearchText, 10000, latitude, longitude);

			// Log.v(TAG,
			// "MYGPSLocation : Size of Result1 - places  " +
	...
	protected void onPreExecute() {
		...
		// progressDialog =
		// ProgressDialog.show(appActivity,"Please Wait...","Retrieving information.");
