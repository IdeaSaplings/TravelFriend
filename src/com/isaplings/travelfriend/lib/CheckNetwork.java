...
//
// NetworkInfo mobileNwInfo =
// conxMgr.getNetworkInfo(ConnectivityManager.TYPE_MOBILE);
// NetworkInfo wifiNwInfo =
// conxMgr.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
//
// return ((mobileNwInfo== null ? false : mobileNwInfo.isAvailable()) ||
// (wifiNwInfo == null ? false : wifiNwInfo.isAvailable()));
//
// }
//
//
...
// {
// ConnectivityManager conxMgr = (ConnectivityManager)
